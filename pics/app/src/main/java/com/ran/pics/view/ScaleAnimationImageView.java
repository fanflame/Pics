...
//            mFitScale = 1.0f;
        ...
        mMaxScale = Math.max(mFitScale, MAX_SCALE * mMinScale);
    ...
    public interface SingleTapListener {
        void onSingleTap(ScaleAnimationImageView imageView);
    }
    ...
    private class GestureListener extends SimpleOnGestureListener {
        ...
        public boolean onSingleTapConfirmed(MotionEvent e) {
            if (singleTapListener != null)
                singleTapListener.onSingleTap(ScaleAnimationImageView.this);
