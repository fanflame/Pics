...
import com.ran.pics.util.UtilsCustomAlbum;
...
public class ImageCache {
     ...
     */
    public ImageCache(Context context, ImageCacheParams cacheParams, String dir) {
        init(context, cacheParams,dir);
    }
     ...
     */
    public ImageCache(Context context, String uniqueName, String dir) {
        init(context, new ImageCacheParams(uniqueName),dir);
    }
    ...
    public static ImageCache findOrCreateCache(
            final FragmentActivity activity, final String uniqueName, String dir) {
        return findOrCreateCache(activity, new ImageCacheParams(uniqueName) ,dir);
    }
     ...
     */
    public static ImageCache findOrCreateCache(
            final FragmentActivity activity, ImageCacheParams cacheParams ,String dir) {
        ...
        if (imageCache == null) {
            imageCache = new ImageCache(activity, cacheParams,dir);
     ...
     */
    private void init(Context context, ImageCacheParams cacheParams, String dir) {
        final File diskCacheDir = DiskLruCache.getDiskCacheDir(context, cacheParams.uniqueName,dir);
        ...
        if (cacheParams.memoryCacheEnabled) {
            mMemoryCache = new LruCache<String, Bitmap>(cacheParams.memCacheSize) {
                ...
                protected int sizeOf(String key, Bitmap bitmap) {
                    return UtilsCustomAlbum.getBitmapSize(bitmap);
                }
            };
        }
    }
